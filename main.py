# Проект по блокчейну для хранения спонсорских данных благотворительных фондов
# Нгуен Линь, Крабу Кира, Ибашьян Анастасия, Попова Алина БИ 439
...
# Эта функция ниже создана для создания самого первого блока и установки его хэша равным "0"
    ...
    def postgre ():
        conn = psycopg2.connect(dbname = 'Foundation', user='postgres', password='123', host='localhost')
        cursor = conn.cursor()
